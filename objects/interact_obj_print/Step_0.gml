if (global.accept_minigame_comsci==true && (place_meeting(x, y, obj_PRINT1) || place_meeting(x, y, obj_PRINT2))) {
	sprite_index = Sprite3;
	image_index = 0;
	if(is_get_score){
		global.print1_GET = true
		is_get_score = false
	}
}else if(global.accept_minigame_comsci==true && !(place_meeting(x, y, obj_PRINT1) || place_meeting(x, y, obj_PRINT2))){
	sprite_index = Red;
	image_index = 0;
